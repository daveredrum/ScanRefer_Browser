            ...
            {/* <div id="detail_container" style={{"position": "absolute", "width": "50%", "height": "300px", "marginTop": "50px", "marginLeft": "450px"}}> */}
                ...
                <div style={{"marginTop": "25px"}}> 
                    ...
                    {/* <div id={"progress_"+this.props.scene_id} style={{"width": "80%", "height": "100%", "display": "inline-block"}}> */}
                        <div id={"verified_"+this.props.scene_id} style={{"height": "100%", "display": "none"}}><span id={"verified_num_"+this.props.scene_id} style={{"color": "white", "fontWeight": "bold"}}></span></div>
                        <div id={"unverified_"+this.props.scene_id} style={{"height": "100%", "display": "none"}}><span id={"unverified_num_"+this.props.scene_id} style={{"color": "white", "fontWeight": "bold"}}></span></div>
                    </div>
